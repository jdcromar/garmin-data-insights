...
export const api = {
  ...
  sync:           (start, end, force = false) => post("/sync", { start, end, force }),
  syncType:       (type, start, end, force = false) => post(`/sync/${type}`, { start, end, force }),
  ...
  exportUrl:      (table, fmt) => `${BASE}/export/${fmt}/${table}`,
